...
/*-------------*/
    ...
    {
        public ulong size;           /* ÉtÉ@ÉCÉãÉTÉCÉY(byte) */
        public byte min;           /* É^ÉCÉÄÉXÉ^ÉìÉv(ï™) */
        public byte hour;          /* É^ÉCÉÄÉXÉ^ÉìÉv(éû) */
        public byte day;           /* É^ÉCÉÄÉXÉ^ÉìÉv(ì˙) */
        public byte month;         /* É^ÉCÉÄÉXÉ^ÉìÉv(åé) */
        public ushort year;          /* É^ÉCÉÄÉXÉ^ÉìÉv(îN) */
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
